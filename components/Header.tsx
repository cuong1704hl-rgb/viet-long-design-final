        ...
        <div className="absolute top-4 right-4 md:top-6 md:right-6 z-20">
            <div className="flex space-x-1 bg-slate-800/80 backdrop-blur-md border border-slate-700/50 p-1 rounded-lg">
                <button
                    ...
                    className={`px-3 py-1 text-sm font-bold rounded-md transition-colors duration-200 ${language === 'vi' ? 'bg-red-600 text-white shadow-md shadow-red-500/20' : 'text-slate-300 hover:bg-slate-700'
                        }`}
                >
                    VN
                </button>
                <button
                    ...
                    className={`px-3 py-1 text-sm font-bold rounded-md transition-colors duration-200 ${language === 'en' ? 'bg-orange-600 text-white shadow-md shadow-orange-500/20' : 'text-slate-300 hover:bg-slate-700'
                        }`}
                >
                    EN
                </button>
