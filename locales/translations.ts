export const translations = {
    vi: {
        // App-wide
        appTitle: "Việt Long thiết kế xây dựng",
        developedBy: "Phòng Kế hoạch kỹ thuật Công ty Việt Long",
        sponsoredBy: "Chỉ sử dụng nội bộ",
        changeLanguage: "Thay đổi ngôn ngữ",
        
        // Welcome Screen
        welcomeHeader: "Việt Long",
        welcomeDescription: "Ứng dụng AI trong thiết kế Xây dựng của Công ty Cổ phần Đầu tư và Xây dựng Việt Long.",
        ...
        loadingUsageLimit: "Giới hạn sử dụng Việt Long thiết kế xây dựng:",
        ...
        alertUpscale: "Vui lòng tải ảnh lên để nâng cấp.",
        ...
        moodboardDesc: "Tạo bảng cảm hứng từ hình ảnh và từ khóa.",
        videoPromptTitle: "Kịch bản Video",
        videoPromptDesc: "Tạo kịch bản chuyển động cho video.",
        lightingTitle: "Thiết lập Ánh sáng",
        lightingDesc: "Thử nghiệm các kịch bản chiếu sáng.",
        virtualTourTitle: "Tham quan ảo",
        virtualTourDesc: "Di chuyển trong không gian 3D bằng AI.",
        extendViewTitle: "Mở rộng View",
        extendViewDesc: "Mở rộng khung hình ảnh (Outpainting).",
        changeStyleTitle: "Thay đổi Style",
        changeStyleDesc: "Chuyển đổi phong cách kiến trúc/nội thất.",
        upscaleTitle: "Cải thiện hình ảnh",
        upscaleDesc: "Tăng độ nét, khử nhiễu và nâng cao chất lượng ảnh.",
        ...
        // Upscale
        uploadImageToUpscale: "1. Tải ảnh cần nâng cấp",
        upscaleFactor: "2. Mức độ xử lý",
        upscaleFactorHelp: "Chọn mức độ can thiệp của AI để làm nét ảnh.",
        generateUpscaleButton: "Nâng cấp ảnh ngay",
        generatingUpscale: "Đang xử lý ảnh...",
        upscaleEmptyHeader: "Ảnh sau khi nâng cấp",
        upscaleEmptyText: "Tải ảnh lên để bắt đầu quá trình xử lý.",
        ...
        constants: {
            ...
            upscaleLevels: [
                { display: "Nhẹ nhàng (Subtle) - Khử nhiễu", value: "subtle" },
                { display: "Cân bằng (Balanced) - Tăng chi tiết", value: "balanced" },
                { display: "Sáng tạo (Creative) - Sắc nét cao", value: "creative" }
            ]
        },
        engineeredPrompts: {
            upscale: {
                subtle: "Khôi phục ảnh nhẹ nhàng. Giữ nguyên màu sắc và chi tiết gốc. Khử nhiễu hạt, làm mịn bề mặt nhưng không làm mất kết cấu tự nhiên. Tăng nhẹ độ nét.",
                balanced: "Nâng cấp ảnh chuyên nghiệp. Tăng độ phân giải lên 4k. Làm nét các chi tiết bị mờ (như vân gỗ, thảm, lá cây). Cân bằng ánh sáng và độ tương phản. Giữ nguyên bố cục và màu sắc.",
                creative: "Tái tạo ảnh chất lượng cao. Tăng cường độ chi tiết tối đa. Làm rõ nét các đường cạnh kiến trúc. Tăng độ sâu trường ảnh. Tạo cảm giác ảnh chụp bằng máy ảnh chuyên nghiệp độ phân giải cao."
            },
            // ... (keep existing engineered prompts) ...
...
You are performing a high-fidelity inpainting operation. Adherence to the mask and style reference is the highest priority.

You are given three images in this order:
1.  **Original Image**: The base image to be modified.
2.  **Mask Image**: A black and white image. Your modifications are **STRICTLY AND EXCLUSIVELY** confined to the **WHITE** area.
3.  **Style Reference Image**: An image providing style guidance.

**Your Task**:
1.  **Forbidden Zone**: The **BLACK** area of the mask is a **NO-CHANGE ZONE**. The pixels in this area on the output image **MUST BE IDENTICAL** to the original.
2.  **User's Request**: Within the white-masked area, apply the following change based on the user's promt: "{0}".
3.  **Style Application**: While applying the change, you **MUST** adopt the style, texture, lighting, color palette, and materials from the **Style Reference Image**. Do not copy shapes or objects from the reference, only its aesthetic qualities.
4.  **Final Output**: Produce a single image where the user's request is fulfilled inside the white mask with the specified style, and the black-masked area is a perfect, unaltered copy of the original. The transition must be seamless.`,
            editWithoutReference: `**CRITICAL INPAINTING DIRECTIVE**
...
3.  **User's Request**: Within the white-masked area, apply the following change based on the user's promt: "{0}".
...
Phân chia rõ 4 nhóm góc như sau:
...
• Lấy nét vào các đối tượng chính như người, lá cây, chim, xe cộ. Đối tượng lấy nét sẽ chiếm tỉ lệ lớn trong khung hình. Công trình chính sẽ bị làm mờ (blur) ở phía sau, tạo hiệu ứng chiều sâu (foreground – background tách biệt).
...
Quan trọng: Chỉ trả về 4 nhóm góc chụp như đã yêu cầu. Không thêm bất kỳ lời dẫn, giới thiệu, hay kết luận nào.`,
...
không được hiển thị phần phân tích chỉ được hiển thị phần Prompt`,
    ...
    en: {
        ...
        loadingUsageLimit: "Viet Long Design Usage Limit:",
        ...
        alertUpscale: "Please upload an image to upscale.",
        ...
        moodboardDesc: "Create a moodboard from image and keywords.",
        videoPromptTitle: "Video Scenarios",
        videoPromptDesc: "Generate detailed motion scripts.",
        lightingTitle: "Lighting Setup",
        lightingDesc: "Test different lighting scenarios.",
        virtualTourTitle: "Virtual Tour",
        virtualTourDesc: "Navigate through 3D space with AI.",
        extendViewTitle: "Extend View",
        extendViewDesc: "Extend the frame of your image (Outpainting).",
        changeStyleTitle: "Change Style",
        changeStyleDesc: "Transform architectural/interior style.",
        upscaleTitle: "Upscale & Enhance",
        upscaleDesc: "Increase resolution, sharpen, and denoise.",
        ...
        // Upscale
        uploadImageToUpscale: "1. Upload image to upscale",
        upscaleFactor: "2. Enhancement Level",
        upscaleFactorHelp: "Choose the intensity of the AI enhancement.",
        generateUpscaleButton: "Upscale Image",
        generatingUpscale: "Upscaling...",
        upscaleEmptyHeader: "Your Upscaled Image",
        upscaleEmptyText: "Upload an image to start processing.",
        ...
        constants: {
            ...
            upscaleLevels: [
                { display: "Subtle - Denoise", value: "subtle" },
                { display: "Balanced - Enhance Detail", value: "balanced" },
                { display: "Creative - High Sharpness", value: "creative" }
            ]
        },
        engineeredPrompts: {
            upscale: {
                subtle: "Subtle image enhancement. Preserve original colors and details. Remove noise and grain, smooth surfaces without losing natural texture. Slightly sharpen edges.",
                balanced: "Professional image upscaling. Increase resolution to 4k. Sharpen blurry details (like wood grain, fabric, leaves). Balance lighting and contrast. Maintain original composition and color palette.",
                creative: "High-quality image recreation. Maximize detail enhancement. Sharpen architectural edges. Increase depth of field. Create the look of a high-resolution professional camera shot."
            },
            // ... (keep existing engineered prompts) ...
...
Clearly divide the prompts into 4 groups as follows:
...
2️⃣ 5 medium shots
• Focus on the relationship between the space and people. Each shot MUST include a human element (e.g., a person reading, walking, or interacting with the space).
...
• Focus on main subjects like people, leaves, birds, or vehicles. The focused subject will occupy a large portion of the frame. The main building will be blurred in the background, creating a depth effect (separate foreground and background).
...
Important: Only return the 4 groups of shots as requested. Do not add any introductions, summaries, or conclusions.`,
